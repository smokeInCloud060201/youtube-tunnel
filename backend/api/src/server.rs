use crate::management::handlers::{clean_storage, upload_cookie};
use crate::player::handlers::{get_video_playlist, request_video, get_video_status, clean_job, clean_all_jobs};
use crate::search::handlers::get_video;
use actix_cors::Cors;
