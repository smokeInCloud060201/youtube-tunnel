...
public class ProxyStreamServiceImpl implements ProxyStreamService {
    ...
    public void proxyWithRange(String upstreamUrl, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Response upstream = client.newCall(getBuilder.build()).execute()) {
            ...
            if (finalType == null) {
                finalType = "audio/mp4"; // many YouTube audio streams are mp4/aac or webm/opus
            }
